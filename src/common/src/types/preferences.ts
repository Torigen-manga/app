...
const themeEnum = z.enum(['default', 'strawberryRush', 'blueberryBreeze']).default('default')
const preferDarkModeEnum = z.enum(['light', 'dark', 'system']).default('system')
const coverStyleEnum = z.enum(['default', 'rounded', 'border', 'shadow']).default('default')
